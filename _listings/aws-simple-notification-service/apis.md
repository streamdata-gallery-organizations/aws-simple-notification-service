...
- name: AWS Simple Notification Service API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/aws-simple-notification-service/master/_listings/aws-simple-notification-service/action-unsubscribe-get.md
x-common:
- type: x-change-log
